...
# Unit tests for MX::MemberConnectionStatusAttributes
# Please update as you see appropriate
describe 'MemberConnectionStatusAttributes' do
  before do
    # run before each test
    @instance = MX::MemberConnectionStatusAttributes.new
  end
  ...
  describe 'test an instance of MemberConnectionStatusAttributes' do
    it 'should create an instance of MemberConnectionStatusAttributes' do
      expect(@instance).to be_instance_of(MX::MemberConnectionStatusAttributes)
    end
  end
