...
# Unit tests for MX::AccountAttributes
# Please update as you see appropriate
describe 'AccountAttributes' do
  before do
    # run before each test
    @instance = MX::AccountAttributes.new
  end
  ...
  describe 'test an instance of AccountAttributes' do
    it 'should create an instance of AccountAttributes' do
      expect(@instance).to be_instance_of(MX::AccountAttributes)
    end
  end
