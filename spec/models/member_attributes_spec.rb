...
# Unit tests for MX::MemberAttributes
# Please update as you see appropriate
describe 'MemberAttributes' do
  before do
    # run before each test
    @instance = MX::MemberAttributes.new
  end
  ...
  describe 'test an instance of MemberAttributes' do
    it 'should create an instance of MemberAttributes' do
      expect(@instance).to be_instance_of(MX::MemberAttributes)
    end
  end
