...
# Unit tests for MX::TransactionAttributes
# Please update as you see appropriate
describe 'TransactionAttributes' do
  before do
    # run before each test
    @instance = MX::TransactionAttributes.new
  end
  ...
  describe 'test an instance of TransactionAttributes' do
    it 'should create an instance of TransactionAttributes' do
      expect(@instance).to be_instance_of(MX::TransactionAttributes)
    end
  end
